...
void send_initial_clock_train (void)		//EDITED
{
    ...
    EALLOW;
    GpioCtrlRegs.GPBLOCK.bit.GPIO50 = 0;
    GpioCtrlRegs.GPBMUX2.bit.GPIO50 = 0;
    GpioCtrlRegs.GPBDIR.bit.GPIO50 = 1;
    GpioCtrlRegs.GPBLOCK.bit.GPIO50 = 1;
    EDIS;
...
void power_on (void)	//EDITED
{
	...
	GpioCtrlRegs.GPBLOCK.bit.GPIO50 = 0;
	GpioCtrlRegs.GPBLOCK.bit.GPIO51 = 0;
	GpioCtrlRegs.GPBLOCK.bit.GPIO52 = 0;
	GpioCtrlRegs.GPBLOCK.bit.GPIO53 = 0;

	//Set up  MUX & DIR
	GpioCtrlRegs.GPBMUX2.bit.GPIO53 = 0;	//Leave as GPIO for manual CS control

	GpioCtrlRegs.GPBGMUX2.bit.GPIO50 = 1;
	GpioCtrlRegs.GPBGMUX2.bit.GPIO51 = 1;
	GpioCtrlRegs.GPBGMUX2.bit.GPIO52 = 1;
	...
	GpioCtrlRegs.GPBPUD.bit.GPIO50 = 0;	//Needs to be normally pulled high
	GpioCtrlRegs.GPBPUD.bit.GPIO51 = 0;	//Needs to be normally pulled high
	...
	GpioCtrlRegs.GPBQSEL2.bit.GPIO52 = 3;
	...
	GpioCtrlRegs.GPBLOCK.bit.GPIO50 = 1;
	GpioCtrlRegs.GPBLOCK.bit.GPIO51 = 1;
	GpioCtrlRegs.GPBLOCK.bit.GPIO52 = 1;
	GpioCtrlRegs.GPBLOCK.bit.GPIO53 = 1;
	EDIS;
...
void set_max_speed(void)			//EDIT
{
    ...
    {
    	spi_freq = SD_CPU_FREQ;
    }
    else
    {
    	spi_freq = SD_CPU_FREQ / (2 * ClkCfgRegs.LOSPCP.bit.LSPCLKDIV);
    }
    baud_f = (spi_freq / SD_SPI_CLK_FREQ) - 1L;
    if (baud_f > 255)
    {
    	baud_f = 255;
    }
    baud = baud_f;
    SpicRegs.SPIBRR.all = baud; // <- (No enforced limit)
